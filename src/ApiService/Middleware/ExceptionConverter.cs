...
internal static class ExceptionConverter
{
    ...
    {
        ErrorModel error = new(serviceException.Code.ToString(), serviceException.Message);
        ...
        {
            details.Add(new ErrorModel(serviceException.Code.ToString(), serviceException.Message));
